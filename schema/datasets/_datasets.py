...
"""
    ...
    adata = scanpy.read("datasets/Davie_fly_brain.h5", backup_url="http://cb.csail.mit.edu/cb/schema/datasets/Davie_fly_brain.h5")
    return adata
...
"""
    ...
    adata = scanpy.read("datasets/Cao_mouse_kidney.h5", backup_url="http://cb.csail.mit.edu/cb/schema/datasets/Cao_mouse_kidney.h5")
    return adata
